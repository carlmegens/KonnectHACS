...
const port=Number(process.env.OUDERAPP_PREVIEW_PORT||8776);
const routes=new Map([
  ['/tests/frontend/index.html','text/html'],
  ['/tests/frontend/harness.js','text/javascript'],
  ['/custom_components/ouderapp/frontend/ouderapp-card.js','text/javascript'],
]);
...
server.listen(port,'127.0.0.1',()=>console.log(`OuderApp synthetic preview: http://127.0.0.1:${port}/tests/frontend/index.html`));
