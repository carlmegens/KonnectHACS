...
**0.1.0 — testversie. Nog niet met een echt ouderaccount getest.**
...
2. Pak `ouderapp-0.1.0-candidate-install.zip` uit in de HA-configuratiemap. Controleer dat `custom_components/ouderapp/manifest.json` bestaat.
...
De frontendmodule wordt automatisch geregistreerd, ook voor de apparaatpop-ups. Bij een dashboard in YAML-modus voeg je zelf een module-resource toe met URL `/ouderapp/automation-card.js?v=0.1.0`. Een volledig hoofdloze HA-installatie kan de sensoren en beveiligde API gebruiken.
